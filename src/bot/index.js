...
const FEATURES = [
  ...
  'poll', 'giveaway', 'wheel', 'reminder', 'music', 'tickets', 'xp', 'gather', 'facility', 'ranch', 'aquarium', 'special', 'trades', 'crops', 'stock', 'tax', 'charity', 'loans', 'home', 'furniture', 'kitchen', 'dex', 'pets', 'affinity', 'help', 'panel'
];
