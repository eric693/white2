// 家園系統核心：房屋 12 階，是廚房／家具／寵物／好感度的共同前提。
//
...
// ---- 12 階房屋。材料全部用你們現有的木材／礦石，玩家湊得到才有意義。----
// [階, 名稱, emoji, 解鎖內容, 金幣, 材料, 家具上限, 寵物上限, 可蓋廚房, 角色可來訪, 家園加成%]
const SEED_LEVELS = [
  [1, '破舊小屋', '🛖', '基礎住宅、家具 ×5', 0, [], 5, 0, 0, 0, 0],
  [2, '溫馨木屋', '🏚️', '家具 ×8、開放寵物區', 3000, [['松木', 80], ['碎石', 60]], 8, 0, 0, 0, 1],
  [3, '鄉間住宅', '🏡', '寵物可入住（1 隻）', 8000, [['橡木', 120], ['黏土', 80], ['煤炭', 50]], 12, 1, 0, 0, 2],
  [4, '精緻平房', '🏠', '取得廚房建造資格', 20000, [['竹子', 150], ['鐵礦', 60], ['碎石', 100]], 16, 1, 1, 0, 3],
  [5, '雙層住宅', '🏘️', '第二空間、家具 ×20', 45000, [['楓木', 200], ['鐵礦', 120], ['黑曜石', 50]], 20, 2, 1, 0, 4],
  [6, '花園別墅', '🏡', '庭院、寵物設施、角色開始願意來訪', 90000, [['櫻花木', 250], ['銀礦', 100], ['硫磺', 80]], 25, 2, 1, 1, 5],
  [7, '高級公寓', '🏢', '高級家具、展示櫃', 170000, [['檜木', 300], ['銀礦', 150], ['金礦', 40]], 30, 3, 1, 1, 6],
  [8, '獨棟豪宅', '🏰', '角色來訪空間', 320000, [['黑檀木', 350], ['金礦', 100], ['水晶', 60]], 35, 3, 1, 1, 8],
