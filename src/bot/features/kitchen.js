...
const SEED_RECIPES = [
  ...
  ['番茄湯', '🍅', 1, [['番茄', 3], ['野草', 1]], 12, 50, 5, 'luck_pct', 2, 60, '酸酸甜甜'],
  ['水煮蛋', '🥚', 1, [['雞蛋', 3]], 8, 35, 4, '', 0, 0, '簡單但不會出錯'],
  ['烤玉米', '🌽', 1, [['玉米', 2], ['煤炭', 1]], 12, 55, 5, '', 0, 0, '夜市的味道'],
  ['蔬菜沙拉', '🥗', 2, [['番茄', 2], ['紅蘿蔔', 2], ['蕨葉', 2]], 15, 80, 7, 'luck_pct', 3, 90, '健康取向'],
  ['蘑菇濃湯', '🍄', 2, [['蘑菇', 4], ['牛奶', 2]], 20, 110, 9, 'luck_pct', 3, 120, '濃郁順口'],
  ...
  ['靈芝藥膳鍋', '🍲', 7, [['靈芝', 2], ['棕熊', 1], ['藥草', 5]], 75, 1500, 60, 'luck_pct', 5, 300, '補到說不出話'],
  ...
  ['鳳凰羽湯', '🔥', 9, [['鳳凰羽', 1], ['靈芝', 3], ['月光花', 2]], 120, 5400, 150, 'luck_pct', 6, 360, '喝完像重生'],
...
const SEED_RECIPES_2 = [
  ...
  ['蘑菇燉羊奶', '🍲', 3, [['蘑菇', 8], ['羊奶', 4], ['野花', 3]], 35, 280, 16, 'luck_pct', 4, 120, '山裡的家常味'],
  ['南瓜濃湯', '🎃', 3, [['南瓜', 4], ['牛奶', 4], ['蘆葦', 2]], 35, 260, 15, 'luck_pct', 3, 90, '秋天限定的溫暖'],
  ...
  ['花園下午茶', '🫖', 8, [['玫瑰', 3], ['百合', 3], ['櫻花', 3], ['蜂蜜', 6], ['牛奶', 6]], 110, 2200, 55, 'affinity_pct', 5, 240, '擺出來就有人想留下來聊天']
];
