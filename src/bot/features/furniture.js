...
const SEED = [
  ...
  ['living', '壁爐', '🔥', 6500, 4, [['碎石', 40], ['煤炭', 25]], 'affinity_pct', 2, '冬天的靈魂'],
  ...
  ['bedroom', '雙人床', '🛌', 5500, 3, [['楓木', 20], ['羊毛', 15]], 'affinity_pct', 2, '兩個人也睡得下'],
  ['bedroom', '全身鏡', '🪞', 4200, 4, [['鐵礦', 10], ['碎石', 15]], '', 0, '出門前照一下'],
  ['bedroom', '梳妝台', '💄', 7000, 5, [['櫻花木', 22], ['銀礦', 6]], '', 0, '瓶瓶罐罐的歸宿'],
  ['bedroom', '香氛台', '🕯️', 8500, 5, [['薰衣草', 30], ['蜂蜜', 10]], 'affinity_pct', 2, '整個房間都是味道'],
  ['bedroom', '豪華大床', '👑', 32000, 8, [['黑檀木', 45], ['羊毛', 40]], 'affinity_pct', 3, '一起躺著什麼都不做'],
  ...
  ['garden', '溫泉池', '♨️', 75000, 10, [['千年神木', 40], ['硫磺', 60], ['碎石', 80]], 'affinity_pct', 3, '泡完全身舒暢'],
  // 收藏
  ...
  ['special', '壁爐搖椅', '🪑', 30000, 9, [['紫檀木', 30], ['羊毛', 20]], 'affinity_pct', 2, '一起發呆一整晚'],
  ['special', '雙人鞦韆', '💑', 55000, 10, [['千年神木', 30], ['金礦', 15]], 'gift_pct', 2, '兩個人剛剛好'],
  ['special', '星光水晶燈', '🔮', 150000, 11, [['世界樹枝', 25], ['鑽石', 8], ['星辰礦', 15]], 'affinity_pct', 2, '角色來訪機率提升'],
  ['special', '角色專屬房', '🚪', 400000, 12, [['月光木', 40], ['龍血木', 30], ['隕石', 5]], 'affinity_pct', 3, '他真的有自己的房間了'],

  // ---- 用新的基礎素材做的家具 ----
  // 新素材（砂礫、樹皮、羽毛、貝殼…）如果只能賣掉就沒意義，這幾件是它們的主要出海口：
  // 便宜、階級門檻低，新手蓋完房子就做得起。
  ['living', '藤編椅', '🪑', 1400, 2, [['藤蔓', 20], ['樹皮', 12]], 'affinity_pct', 1, '夏天坐起來不黏背'],
  ['living', '貝殼風鈴', '🐚', 1100, 2, [['貝殼', 25], ['藤蔓', 8]], 'luck_pct', 1, '風一吹就叮叮噹噹'],
  ['bedroom', '羽毛枕被', '🪶', 2400, 3, [['羽毛', 40], ['獸皮', 10]], 'affinity_pct', 2, '一躺下去就不想起來'],
  ['bedroom', '獸皮地墊', '🟫', 2800, 3, [['獸皮', 25], ['骨頭', 10]], 'affinity_pct', 1, '踩上去暖暖的'],
  ...
  // ---- 中階木材專用家具（Lv.4～6）----
  // 楓木／櫻花木／檜木本來只有房屋 Lv.5～7 會用，中期玩家囤著沒處花。
  // 這一批門檻剛好卡在那個階段，價格與加成也介於便宜貨與後期精品之間。
  ['living', '楓木長桌', '🍁', 9000, 4, [['楓木', 30], ['鐵礦', 8]], 'sell_pct', 1, '一家人吃飯剛剛好'],
  ['living', '櫻花木屏風', '🌸', 12000, 5, [['櫻花木', 28], ['藤蔓', 15]], 'gift_pct', 2, '光透過來的樣子很好看'],
  ['bedroom', '檜木衣櫃', '🚪', 15000, 5, [['檜木', 32], ['銀礦', 6]], 'affinity_pct', 2, '打開就是森林的味道'],
  ['bedroom', '楓木搖籃椅', '🪑', 11000, 4, [['楓木', 26], ['羊毛', 12]], 'affinity_pct', 2, '坐著坐著就睡著了'],
  ['kitchen', '檜木料理檯', '🔪', 18000, 6, [['檜木', 35], ['鐵礦', 15], ['石英', 10]], 'cook_perfect_pct', 2, '刀工好不好，檯面知道'],
  ['kitchen', '櫻花木餐櫃', '🍽️', 14000, 5, [['櫻花木', 30], ['黏土', 20]], 'cook_price_pct', 2, '碗盤擺得整整齊齊'],
  ['garden', '楓木花架', '🌿', 8000, 4, [['楓木', 22], ['藤蔓', 12], ['苔蘚', 10]], 'speed_pct', 2, '爬藤植物最愛的家'],
  ['garden', '櫻花木鞦韆', '🌺', 16000, 6, [['櫻花木', 35], ['藤蔓', 20], ['羊毛', 10]], 'affinity_pct', 2, '角色來了都想坐一下'],
  ['collection', '檜木標本櫃', '🗄️', 20000, 6, [['檜木', 30], ['水晶', 6], ['銀礦', 10]], 'luck_pct', 2, '收藏品終於有地方放'],
  ['special', '楓木書桌', '📚', 17000, 6, [['楓木', 35], ['黑曜石', 12], ['石英', 12]], 'affinity_pct', 2, '坐下來就特別專心']
];
