...
const SEED = [
  ...
  ['bedroom', '檜木衣櫃', '🚪', 15000, 5, [['檜木', 32], ['銀礦', 6]], 'energy_pct', 2, '打開就是森林的味道'],
  ['bedroom', '楓木搖籃椅', '🪑', 11000, 4, [['楓木', 26], ['羊毛', 12]], 'energy_pct', 2, '坐著坐著就睡著了'],
  ...
  ['special', '楓木書桌', '📚', 17000, 6, [['楓木', 35], ['黑曜石', 12], ['石英', 12]], 'xp_pct', 2, '坐下來就特別專心']
];
