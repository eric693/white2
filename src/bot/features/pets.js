...
const PET_CATS = {
  ...
  affinity: { name: '💕 好感度加成', hint: '送禮／逛街／來訪拿到的好感點數變多' }
};
const catLabel = (p) => {
...
const SEED_PETS = [
  // ---- 一般寵物：給生產／經濟加成 ----
  ['橘貓', '🐈', 'N', 3, 8000, [['小魚', 10]], '慵懶陪伴', 'affinity_pct', 3, 24, '整天都在睡，但你回家牠會來蹭'],
  ...
  ['貓頭鷹', '🦉', 'SR', 5, 95000, [['野鳥蛋', 12]], '夜行智慧', 'affinity_pct', 5, 20, '整夜盯著你工作'],
  ...
  ['鳳凰雛', '🦅', 'UR', 10, 1600000, [['鳳凰羽', 1], ['靈芝', 20]], '不死祝福', 'affinity_pct', 10, 12, '據說牠死了還會再回來'],
