...
App.page('stock', {
  help: {
    "intro": "掛牌股票與交易規則。股價的漲跌由「世界動態」那一頁推動，這裡管的是股票本身與交易參數。",
    "steps": [
    ...
    "notes": [
      "手續費買進與賣出各收一次（預設各 1.5%），收到的錢直接銷毀（星幣回收），不進任何人口袋。股票不收持有稅，也開放當沖（當天買當天可賣）。",
    ...
    "terms": [
      ...
      [
        "證券稅（持有稅）",
        "按持股市值課的舊稅目，已於 2026-09 隨整套資產稅移除，不再課徵。股票現在只在買賣時收手續費。"
      ]
    ]
  },
