// ===== 銀行：存款 ＋ 信用貸款 =====
// （物資貸款／物資抵押已於 2026-09 停辦，本頁保留舊借據的還款與贖回）
App.page('loans', {
  help: {
    ...
    "notes": [
      "「立即處理到期貸款」是交給管家那隻機器人跑的，按下去最多等 30 秒；管家沒上線會提示工作已排隊，上線後自動補做。",
  ...
  title: '銀行', sub: '存款（按日生息）與信用貸款（免抵押）；物資貸款已停辦，僅保留舊借據還款', module: 'loans',
