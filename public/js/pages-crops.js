...
App.page('crops', {
  help: {
    "intro": "農地種作物、溫室種花卉。玩家先買種子放進背包，再種下去，成熟採收後產物進背包可賣。",
    "steps": [
      "「種子」設成熟時間、種子價格與收成數量，並指定成熟後產出哪個物品。",
      "格數與加成由「設施商店」的農地／溫室等級決定，不在這一頁。"
    ],
    "notes": [
      "設施的『時間 -N%』在種下當刻就算死，之後升級不會回溯已種下的作物。",
      "設施的『產量 +N%』會在採收時套用；收成數量小的時候用機率補足小數，長期期望值等於加成％。"
    ]
  },
