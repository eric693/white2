...
App.page('currency', {
  help: {
    "intro": "所有玩家的錢包一覽，可以直接搜尋名字增減星幣。",
    "steps": [
      "搜尋玩家名字，在該列直接填要增減的數量，正數是給、負數是扣。",
      "扣款不會把餘額扣成負數，最低到 0 為止。"
    ],
    "notes": [
      "單次增減上限 100 億、單人餘額上限 1 兆。這是防呆：超過系統可精確計算的範圍（約 9,007 兆）後，餘額會失去精度、加 1 塊錢沒反應，還會污染稅收與基金會。",
      "活動要發錢給大家，請用「基金會 → 手動普發」，有試算可以先看發多少、幾個人。"
    ]
  },
