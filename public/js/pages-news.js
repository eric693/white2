...
App.page('news', {
  help: {
    ...
    "notes": [
      "不是每則動態都要有遊戲效果——影響欄位留空就純粹是則故事，想連動物價或股價再填。",
      "遊戲公告已經併進這一頁，不再另外開一個公告入口（兩個入口只會讓人漏看其中一個）。",
      "物價調整會影響 NPC 收購價，玩家背包裡東西的賣價會立刻改變。",
      "有效果的動態是整點生效的，寫幾小時就影響幾小時；到期自動失效，價格回到基準。",
      "可以把重要的動態釘選，讓它固定顯示在最上面。"
    ],
    "terms": [
      ["世界動態", "原本叫「財經新聞」，2026-09 擴充成整個世界的時間軸，範圍不再限於物價與股價。"]
    ]
  },
